      ...
      <View style={RuleStyles.Layout}>
        <ScrollView style={RuleStyles.ScrollViewStyle} minimumZoomScale={1} maximumZoomScale={10}>
          ...
          <HighlightText style={RuleStyles.Description}>
            ...
            {'\t'}<HighlightText style={RuleStyles.SubHeading2}>A.</HighlightText>This rule shall not apply to players outside the top thirty (30) as of November 13, 2023
            (Commitment Players).{'\n\n'}
            ...
            {'\t'}<HighlightText style={RuleStyles.SubHeading2}>C.</HighlightText>A. player who is entered into an ATP Tour 250 tournament may participate in a special
            ...
            {'\t'}<HighlightText style={RuleStyles.SubHeading2}>D.</HighlightText>A. player has the right to petition the ATP CEO or his designee for an exemption to
            ...
            {'\t'}<HighlightText style={RuleStyles.SubHeading2}>E.</HighlightText> Violations of this section are subject to penalties described under the player Major
