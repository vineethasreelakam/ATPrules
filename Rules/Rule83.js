            ...
            <View style={RuleStyles.Layout}>
                <ScrollView style={RuleStyles.ScrollViewStyle} minimumZoomScale={1} maximumZoomScale={10}>
                    ...
                    <HighlightText style={RuleStyles.Description}>
                        ...
                        {'\n\n\t'}
                        <HighlightText style={RuleStyles.SubHeading3}>ATP Tour Tournaments. </HighlightText>The scheduled transportation must meet ATP quality standards and be available from 7AM local time (with advanced booking required for
                        ...
                        {'\n\n\t'}
                        <HighlightText style={RuleStyles.SubHeading3}>Combined Events and Challenger 175. </HighlightText>Each Tournament shall provide airport
