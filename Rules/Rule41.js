      ...
      <View style={RuleStyles.Layout}>
        <ScrollView style={RuleStyles.ScrollViewStyle} minimumZoomScale={1} maximumZoomScale={10}>
          ...
          <HighlightText style={RuleStyles.Description}>
            ...
            items and information related to the application of the Masters 1000 Player 
            Compensation Rule to the extent requested by the player member(s) of the M1000 PM 
            Committee and shall provide comfort to such member(s) as to the accuracy of the M1000
            ...
            Tournament Income Statement will be reported in accordance with Generally 
            Accepted Accounting Principles in the United States (“US GAAP”), the International
            ...
            the ATP Chairman will provide a brief description of his or her reason for such 
            decision to the M1000 PM Committee. The M1000 PM Committee will meet regularly as
            ...
            PM Committee Auditor as required under this rule (including with respect to the 
