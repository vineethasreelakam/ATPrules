...
import { SubIndex2_List } from '../screens/SubIndexList.js';

export default function Rule22({ navigation }) {
  return (
    <>
      ...
      <RuleNavigationButtons props={{ prev: 'Rule189', next: 'Rule23', nav: navigation }} />
    </>
  );
}
