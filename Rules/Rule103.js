                ...
                <ScrollView style={RuleStyles.ScrollViewStyle} minimumZoomScale={1} maximumZoomScale={10}>
                   ...
                   <ZoomText>
                    <HighlightText style={RuleStyles.Description}>
                        <HighlightText style={RuleStyles.SubHeading1}>7.13 Selection of Entries</HighlightText>
                        {'\n\n\t'}
                        <HighlightText style={RuleStyles.SubHeading2}> A.Singles Main Draw</HighlightText>
                        {'\n\n\t\t'}
                        ...
                        {'\n\n\t\t'}
                        <HighlightText style={RuleStyles.SubHeading3}>3) Special Exempts (SE). </HighlightText>Players may receive a special exempt into the main draw
                        ...
                        {'\n\n\t\t'}
                        <HighlightText style={RuleStyles.SubHeading3}>4) Wild Cards.</HighlightText> Wild cards are players included in the main draw at the sole discretion of the tournament.* Wild cards must be named at the time the draw is
                        ...
                        * See 7.12 A. 2) for restrictions pertaining to ATP Tour 500 additional Wild Card.
                        {'\n\n\t\t\t'}
                        <HighlightText style={RuleStyles.SubHeading3}>May I Accept a Challenger Wild Card after Losing in an ATP
                            Tour Qualifying?</HighlightText>
                        {'\n\n\t\t\t'}
                        <HighlightText style={RuleStyles.SubHeading3}>Case: </HighlightText>Can a Tournament Director at a Challenger, which is held in
                        ...
                        Tour event?
                        {'\n\n\t\t\t'}
                        <HighlightText style={RuleStyles.SubHeading3}>Decision: </HighlightText>No. A player may only compete in one tournament per
                        week.
                        {'\n\n\t\t\t'}
                        <HighlightText style={RuleStyles.SubHeading3}>May I Play Grand Slam Qualifying After Losing in an ATP Tour
                            tournament?</HighlightText>
                        {'\n\n\t\t\t'}
                        <HighlightText style={RuleStyles.SubHeading3}>Case: </HighlightText>Can a player lose in the main draw of an ATP event, which is
                        ...
                        same week?
                        {'\n\n\t\t\t'}
                        <HighlightText style={RuleStyles.SubHeading3}>Decision: </HighlightText>Yes, as long as he meets the entry deadline set by the
                        ...
                        different weeks.
                        {'\n\n\t\t\t'}
                        <HighlightText style={RuleStyles.SubHeading3}>May I Accept a Wild Card after Withdrawing from an ATP Tour
                            Qualifying?</HighlightText>
                        {'\n\n\t\t\t'}
                        ...
                        {'\n\n\t\t\t'}
                        <HighlightText style={RuleStyles.SubHeading3}>May I Sign In for Doubles after Withdrawing from an ATP Tour
                            Qualifying?</HighlightText>
                        {'\n\n\t\t\t'}
                        <HighlightText style={RuleStyles.SubHeading3}>Case: </HighlightText>A player was still competing on the day before Qs started at
                        ...
                        rules.
                        {'\n\n\t'}
                        <HighlightText style={RuleStyles.SubHeading2}>B.Singles Qualifying </HighlightText>
                        {'\n\n\t\t'}
                        <HighlightText style={RuleStyles.SubHeading3}>1) Direct acceptances – ATP Tour.</HighlightText> Direct acceptances are players accepted directly in the draw by virtue of their position in the Pepperstone ATP Rankings or
                        ...
                        {'\n\n\t\t'}
                        <HighlightText style={RuleStyles.SubHeading3}>2) Direct acceptances – ATP Challenger Tour (50-125). </HighlightText>
                        {'\n\n\t\t\t'}
                        ...
                        May he do this?
                        {'\n\n\t\t\t\t'}
                        <HighlightText style={RuleStyles.SubHeading3}>Decision: </HighlightText>No, the intent to use a protected ranking must be declared at the time of entry and cannot be declared after the deadline
                        for the event.
                        {'\n\n\t\t\t'}
                        ...
                        {'\n\n\t\t\t'}
                        <HighlightText style={RuleStyles.SubHeading3}>Can I Sign In</HighlightText>
                        {'\n\n\t\t\t'}
                        <HighlightText style={RuleStyles.SubHeading3}>Case: </HighlightText>An ATP Tour tournament with an advanced entry qualifying
                        ...
                        sign-in sheet?
                        {'\n\n\t\t\t'}
                        <HighlightText style={RuleStyles.SubHeading3}>Decision:</HighlightText> Yes. Following the sign-in occurring prior to the qualifying
                        ...
                        {'\n\n\t\t\t'}
                        <HighlightText style={RuleStyles.SubHeading3}>Case: </HighlightText>The tournament has used their wild card allocation. Are players without a ranking eligible to sign in as alternates?
                        <HighlightText style={RuleStyles.SubHeading3}>Decision:</HighlightText> No. Unranked players are only allowed into the draw as a
                        wild card selection.
                        {'\n\n\t\t\t'}
                        <HighlightText style={RuleStyles.SubHeading3}>Fill by Random or Alternative Method</HighlightText>
                        {'\n\n\t\t\t'}
                        <HighlightText style={RuleStyles.SubHeading3}>Case: </HighlightText>After concluding the qualifying sign-in, there are not a sufficient number of players listed in the Pepperstone ATP Rankings
                        ...
                        wild card selection.
                        {'\n\n\t\t\t'}
                        <HighlightText style={RuleStyles.SubHeading3}>Case:</HighlightText> A player asks to be signed-in to the doubles qualifying which
                        ...
                        {'\n\n\t\t\t'}
                        <HighlightText style={RuleStyles.SubHeading3}>Decision: </HighlightText>The entry for doubles qualifying cannot be accepted. The
                        player could sign-in for main draw doubles, but not for qualifying.
                        {'\n\n\t'}
                        <HighlightText style={RuleStyles.SubHeading2}>C.Doubles Main Draw - ATP Tour. </HighlightText>Direct acceptances for ATP Tour events shall be in
                        the following order:
                        {'\n\n\t\t'}
                        ...
                        {'\n\n\t\t\t'}
                        <HighlightText style={RuleStyles.SubHeading3}>Note: </HighlightText>For ties between teams with the same composition:
                        {'\n\n\t\t\t\t'}
                        ...
                        a draw.
                        {'\n\n\t\t\t\t'}
                        <HighlightText style={RuleStyles.SubHeading3}>Case:</HighlightText> A player enters an event using his current ranking. After the
                        deadline, he realizes he did not get in with his current ranking and
                        informs the Supervisor that he wants to use his protected ranking.
                        May he do this?
                        {'\n\n\t\t\t\t'}
                        ...
                        {'\n\n\t\t\t'}
                        <HighlightText style={RuleStyles.SubHeading3}>Case: </HighlightText>A doubles team has one player who is listed in the Pepperstone ATP Rankings or Pepperstone ATP Doubles Ranking and one
                        player who is not. Can the team be in the doubles draw?
                        {'\n\n\t\t\t'}
                        <HighlightText style={RuleStyles.SubHeading3}>Decision:</HighlightText> Since one player does not have a ranking, the only way
                        into the draw is via a wild card.
                        {'\n\n\t\t\t'}
                        <HighlightText style={RuleStyles.SubHeading3}>NOTE: </HighlightText>The rationale for this is that all players, except Wild Cards,
                        ...
                        {'\n\n\t\t\t'}
                        <HighlightText style={RuleStyles.SubHeading3}>Case: </HighlightText>A player has a protected singles ranking of 201, true singles
                        ...
                        {'\n\n\t\t\t'}
                        <HighlightText style={RuleStyles.SubHeading3}>Decision:</HighlightText> The protected singles ranking CAN be used for entry into
                        the doubles. It would not count against his allowed total for singles
                        events but would count against his doubles allotment.
                        {'\n\n\t'}
                        <HighlightText style={RuleStyles.SubHeading2}>D. Doubles Main Draw – ATP Challenger Tour</HighlightText>
                        {'\n\n\t'}
                        Challenger 50-125
                        {'\n\n\t'}
                        ...
                        a draw.
                        {'\n\n\t'}
                        <HighlightText style={RuleStyles.SubHeading2}>E. Seeds - ATP Tour and ATP Challenger Tour</HighlightText>
                        {'\n\n\t'}
                        ...
                        {'\n\n\t'}
                        <HighlightText style={RuleStyles.SubHeading2}>F. Qualifiers </HighlightText>
                        {'\n\n\t'}
                        ...
                        ends.
                        {'\n\n\t'}
                        <HighlightText style={RuleStyles.SubHeading2}>G.Wild Cards.</HighlightText> Wild cards are players included in the main draw at the sole discretion of
