            ...
            <View style={RuleStyles.Layout}>
                <ScrollView style={RuleStyles.ScrollViewStyle} minimumZoomScale={1} maximumZoomScale={10}>
                    ...
                    <HighlightText style={RuleStyles.Description}>
                        <HighlightText style={RuleStyles.SubHeading1}>7.20 Lucky Losers, Substitutions and Vacancies</HighlightText>
                        {'\n\n'}
                        <HighlightText style={RuleStyles.SubHeading2}>A.Lucky Loser Selection</HighlightText>
                        {'\n\n'}
                        <HighlightText style={RuleStyles.SubHeading3}>32/16Q Draw </HighlightText>events shall use the same protocol as secified for ATP Tour events in
                        ...
                        * To be eligible, alternate teams who did not enter through the on-site protocol
                        must sign-in on the first day of the doubles competition.
                        {'\n\n'}
                        <HighlightText style={RuleStyles.SubHeading3}>Case:</HighlightText> A team submits an advance entry for a 250 tournament with
                        ...
                        ranking?
                        {'\n\n'}
                        <HighlightText style={RuleStyles.SubHeading3}>Decision:</HighlightText> The team using the protected ranking is placed at the
                        ...
                        {'\n\n'}
                        <HighlightText style={RuleStyles.SubHeading3}>Who is inserted as the doubles alternate?</HighlightText>
                        {'\n\n'}
                        <HighlightText style={RuleStyles.SubHeading3}>Case 1:</HighlightText> After the sign-in deadline for doubles alternate has closed,
                        ...
                        now?
                        {'\n\n'}
                        <HighlightText style={RuleStyles.SubHeading3}>Decision:</HighlightText> If an eligible alternate team cannot be found who is ready
                        ...
                        <HighlightText style={RuleStyles.SubHeading3}>ATP POLICY:</HighlightText> While every effort must be made to locate an eligible,
                        ...
                        {'\n\n'}
                        <HighlightText style={RuleStyles.SubHeading3}>Case 2:</HighlightText> A doubles match is called at 11:00 AM and one of the
                        ...
                        {'\n\n'}
                        <HighlightText style={RuleStyles.SubHeading3}>ATP POLICY:</HighlightText> Alternates (Lucky Losers) are to be ready when
                        ...
                        {'\n\n'}
                        <HighlightText style={RuleStyles.SubHeading3}>Advance Entry Qualifying</HighlightText>
                        {'\n\n'}
                        <HighlightText style={RuleStyles.SubHeading3}>Case:</HighlightText> How are vacancies handled for ATP Tour qualifying events if
                        ...
                        {'\n\n'}
                        <HighlightText style={RuleStyles.SubHeading3}>Decision: </HighlightText>If there are no eligible players remaining on the Advanced Entry list and there are not enough players who signed the
                        ...
                        {'\n\n'}
                        <HighlightText style={RuleStyles.SubHeading3}>Decision:</HighlightText> If there are not enough teams who signed the Qualifying
                        ...
                        Alternate sign-in list.
                        {'\n\n'}
                        <HighlightText style={RuleStyles.SubHeading2}>B.Lucky Loser/Alternate Substitution</HighlightText>
                        {'\n\n'}
                        ...
                        match is struck.
                        {'\n\n'}
                        <HighlightText style={RuleStyles.SubHeading3}>NOTE:</HighlightText> A player winning a match by walkover is considered to have played a
                        match.
                        {'\n\n'}
                        ...
                        {'\n\n'}
                        <HighlightText style={RuleStyles.SubHeading3}>Alternate Sign-In Procedures</HighlightText>
                        {'\n\n'}
                        <HighlightText style={RuleStyles.SubHeading3}>Case: </HighlightText>The two (2) players ahead on an alternate list do not sign in
                        ...
                        {'\n\n'}
                        <HighlightText style={RuleStyles.SubHeading3}>Decision:</HighlightText> Neither of the two (2) players. In order to be eligible for
                        ...
                        {'\n\n'}
                        <HighlightText style={RuleStyles.SubHeading3}>Case:</HighlightText> A team signs in for doubles at two tournaments the same
                        ...
                        {'\n\n'}
                        <HighlightText style={RuleStyles.SubHeading3}>Decision:</HighlightText> Yes, however, a team is only eligible to be signed in on
                        one “live” list per day.
                        {'\n\n'}
                        <HighlightText style={RuleStyles.SubHeading3}>Eligible for Lucky Loser - ATP Tour</HighlightText>
                        {'\n\n'}
                        <HighlightText style={RuleStyles.SubHeading3}>Case:</HighlightText> May a player or team sign the lucky loser sign-in sheet if they
                        are not accepted into the qualifying competition?
                        {'\n\n'}
                        <HighlightText style={RuleStyles.SubHeading3}>Decision:</HighlightText> No. To be eligible as a lucky loser, a player or team must
                        have played and lost in the qualifying event.
                        {'\n\n'}
                        <HighlightText style={RuleStyles.SubHeading3}>Extending Closing Times</HighlightText>
                        {'\n\n'}
                        <HighlightText style={RuleStyles.SubHeading3}>Case:</HighlightText> The first-round singles matches are scheduled to start at 10
                        ...
                        extended?
                        {'\n\n'}
                        <HighlightText style={RuleStyles.SubHeading3}>Decision:</HighlightText> Yes. Extend the deadline to 10:30 a.m.
                        {'\n\n'}
                        <HighlightText style={RuleStyles.SubHeading3}>Case:</HighlightText> The lucky loser Sign-in closed at 10:30. A player arrives at
                        ...
                        {'\n\n'}
                        <HighlightText style={RuleStyles.SubHeading3}>Decision: </HighlightText>The vacancy should be filled from Monday’s lucky loser
                        ...
                        shall be awarded.
                        {'\n\n'}
                        <HighlightText style={RuleStyles.SubHeading3}>Who Goes In?</HighlightText>
                        {'\n\n'}
                        <HighlightText style={RuleStyles.SubHeading3}>Case:</HighlightText> A player withdraws from the singles event on Tuesday. His
                        ...
                        {'\n\n'}
                        <HighlightText style={RuleStyles.SubHeading3}>Decision: </HighlightText>Tuesday’s sign-in.
                        {'\n\n'}
                        <HighlightText style={RuleStyles.SubHeading2}>C. Vacancies - Doubles</HighlightText>
                        {'\n\n'}
                        <HighlightText style={RuleStyles.SubHeading2}>ATP Tour</HighlightText>
                        {'\n\n'}
                        ...
                        {'\n\n'}
                        <HighlightText style={RuleStyles.SubHeading3}>Can I Sign In For Q’s after Withdrawing from Doubles?</HighlightText>
                        {'\n\n'}
                        <HighlightText style={RuleStyles.SubHeading3}>Case: </HighlightText>A player is withdrawing from a Doubles Advanced Entry list
                        ...
                        {'\n\n'}
                        <HighlightText style={RuleStyles.SubHeading3}>Decision: </HighlightText>No. However, his partner, who was not the reason for the
                        ...
                        {'\n\n'}
                        <HighlightText style={RuleStyles.SubHeading3}>Case: </HighlightText>A player, who is main draw in doubles, is offered a singles
                        ...
                        another event?
                        {'\n\n'}
                        <HighlightText style={RuleStyles.SubHeading3}>Decision:</HighlightText> Yes. The player can withdraw from the doubles before
                        ...
                        {'\n\n'}
                        <HighlightText style={RuleStyles.SubHeading3}>Case:</HighlightText> A player’s doubles partner withdraws after the on-site sign-in
                        ...
                        {'\n\n'}
                        <HighlightText style={RuleStyles.SubHeading3}>Decision: </HighlightText>No. The player seeking a new partner may not team
                        ...
                        {'\n\n'}
                        <HighlightText style={RuleStyles.SubHeading3}>ATP Challenger Tour</HighlightText>
                        {'\n\n'}
                        1) A team shall constitute a doubles entry. If either of the players of a team cannot
                        play, that doubles entry is subject to withdrawal and substitution.
                        {'\n\n'}
                        ...
                        {'\n\n'}
                        <HighlightText style={RuleStyles.SubHeading2}>D.Prior to Qualifying Competition </HighlightText>
                        {'\n\n'}
                        <HighlightText style={RuleStyles.SubHeading3}>1) ATP Tour Singles.</HighlightText> After the main draw is made and prior to the commencement
                        ...
                        {'\n\n'}
                        <HighlightText style={RuleStyles.SubHeading3}>2) ATP Tour Doubles.</HighlightText> After the main draw is made and prior to the commencement of the qualifying competition, all vacancies created by the withdrawal of unseeded teams including wild card withdrawals, shall be filled by the next highest
                        positioned player(s) on the on-site entry list. If the vacancy was created by the
                        withdrawal of a seed, then the procedures for replacing seeds are followed and
                        the vacancy created by replacing the seed is filled by the next highest positioned
                        player(s) on the on-site entry list.
                        {'\n\n'}
                        <HighlightText style={RuleStyles.SubHeading3}>3) ATP Challenger Tour.</HighlightText> After the withdrawal deadline and prior to the start of
                        ...
                        {'\n\n'}
                        <HighlightText style={RuleStyles.SubHeading3}>ATP Tour Main Draw Vacancy Before Qualifying Starts</HighlightText>
                        {'\n\n'}
                        <HighlightText style={RuleStyles.SubHeading3}>Case:</HighlightText> After making the qualifying draw, a vacancy occurs in the
                        main draw. How is the vacancy filled?
                        {'\n\n'}
                        <HighlightText style={RuleStyles.SubHeading3}>Decision: </HighlightText>If the qualifying competition has begun, the vacancy is
                        ...
                        acceptance list.
                        {'\n\n'}
                        <HighlightText style={RuleStyles.SubHeading2}>E. Qualifying started or finished</HighlightText>
                        {'\n\n'}
                        <HighlightText style={RuleStyles.SubHeading3}>1) During Qualifying Competition.</HighlightText> If a lucky loser position should become available during the qualifying competition, it shall be treated the same as the qualifying places for placement in the main draw. If a seeded player or team withdraws
                        ...
                        {'\n\n'}
                        <HighlightText style={RuleStyles.SubHeading3}>a) 32/48/64/96 Singles </HighlightText>Draw and 16/24/32 Doubles Draws. The vacancy shall
                        ...
                        {'\n\n'}
                        <HighlightText style={RuleStyles.SubHeading3}>b) 28 Draw. </HighlightText>If the vacancy involves a seed #1-4, then seed #5 moves to the
                        ...
                        {'\n\n'}
                        <HighlightText style={RuleStyles.SubHeading3}>c) 56 Draw. </HighlightText>If the vacancy involves a seed #1-8, then seed #9 moves to the
                        ...
                        {'\n\n'}
                        <HighlightText style={RuleStyles.SubHeading3}>Seeds Withdraw or Are Withdrawn</HighlightText>
                        {'\n\n'}
                        <HighlightText style={RuleStyles.SubHeading3}>Case:</HighlightText> The team seeded 4th withdraws after the draw but prior to
                        the order of play being released for the first day of main draw. How
                        is the vacancy filled?
                        {'\n\n'}
                        <HighlightText style={RuleStyles.SubHeading3}>Decision:</HighlightText> For a 16 team draw, the vacancy created by the removal
                        ...
                        {'\n\n'}
                        <HighlightText style={RuleStyles.SubHeading3}>Qualifier Eligible To Be Seeded</HighlightText>
                        {'\n\n'}
                        <HighlightText style={RuleStyles.SubHeading3}>Case:</HighlightText> A qualifier’s ranking was high enough for him to be seeded in
                        ...
                        {'\n\n'}
                        <HighlightText style={RuleStyles.SubHeading3}>Decision:</HighlightText> Yes. The successful qualifier shall be accorded the same
                        ...
                        {'\n\n'}
                        <HighlightText style={RuleStyles.SubHeading3}>2) Other Vacancy Procedures After Qualifying Starts.</HighlightText>
                        {'\n\n'}
                        ...
                        in the draw.
                        {'\n\n'}
                        <HighlightText style={RuleStyles.SubHeading3}>When is the withdrawn player replaced?</HighlightText>
                        {'\n\n'}
                        <HighlightText style={RuleStyles.SubHeading3}>Case:</HighlightText> A player withdraws from the main draw 2 hours prior to the
                        ...
                        {'\n\n'}
                        <HighlightText style={RuleStyles.SubHeading3}>Decision:</HighlightText> The player is not inserted in the draw until after the signin deadline as others may withdraw necessitating drawing for the
