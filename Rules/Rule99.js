            ...
            <View style={RuleStyles.Layout}>
                <ScrollView style={RuleStyles.ScrollViewStyle} minimumZoomScale={1} maximumZoomScale={10}>
                    ...
                    <Text style={RuleStyles.Description}>
                        <Text style={RuleStyles.SubHeading1}>7.09 Size and Method of Draw</Text>
                        {'\n\n'}
                        <Text style={RuleStyles.SubHeading2}> A.Main Draw</Text>
                        {'\n\n'}
                        <Text style={RuleStyles.SubHeading3}> 1) Singles</Text>
                        {'\n\n'}
                        <Text style={RuleStyles.SubHeading3}>a) 28 Competitors.</Text> A draw sheet with 32 places shall be used. After the seeds
                        ...
                        the draw.
                        <Text style={RuleStyles.SubHeading3}>b) 32 or 64 Competitors.</Text> A draw sheet of 32 or 64 places shall be used. After
                        the seeds are placed, the remaining players, including the qualifiers, shall be
                        drawn and placed in the vacant spaces in the draw, beginning at the top of
                        the draw.
                        <Text style={RuleStyles.SubHeading3}>c) 48 or 56 Competitors. </Text>A draw sheet with 64 places shall be used. After the
                        ...
                        top of the draw.
                        <Text style={RuleStyles.SubHeading3}>d) 96 Competitors.</Text> A draw sheet with 128 places shall be used. After the seeds
                        and byes are placed, the remaining players, including the qualifiers, shall be
                        drawn and placed in the vacant spaces in the draw, beginning at the top of
                        the draw
                        {'\n\n'}
                        <Text style={RuleStyles.SubHeading3}>2) Doubles</Text>
                        {'\n\n'}
                        ...
                        main draw
                        {'\n\n'}
                        <Text style={RuleStyles.SubHeading2}>B.Qualifying Draw</Text>
                        {'\n\n'}
                        ...
                        {'\n\n'}
                        <Text style={RuleStyles.SubHeading2}>2) Doubles - ATP Tour 500</Text>
                        {'\n\n'}
                        ...
                        possible.
                        {'\n\n'}
                        <Text style={RuleStyles.SubHeading3}>Correcting an Error in Seeding</Text>
                        {'\n\n'}
                        ...
                        may be taken?
                        {'\n\n'}
                        <Text style={RuleStyles.SubHeading3}>Decision:</Text> If the players or teams involved in the error have not
                        ...
                        {'\n\n'}
                        <Text style={RuleStyles.SubHeading3}>Don’t Have Eight Seeds</Text>
                        {'\n\n'}
                        <Text style={RuleStyles.SubHeading3}>Case:</Text> In a qualifying draw, there are only seven (7) players listed
                        ...
                        placed in the Draw?
                        {'\n\n'}
                        <Text style={RuleStyles.SubHeading3}>Decision: </Text>Draw seeds 5, 6 and 7 for placement in sections 2,3 and
                        4.
                        {'\n\n'}
                        <Text style={RuleStyles.SubHeading3}>Main Draw Seed for a Qualifier</Text>
                        {'\n\n'}
                        <Text style={RuleStyles.SubHeading3}>Case: </Text>May a player who gains a place in the main draw by qualifying be seeded in the main draw?
                        {'\n\n'}
                        <Text style={RuleStyles.SubHeading3}>Decision: Yes.</Text> However, if the main draw is made prior to the completion of the qualifying, then the original seedings are final.
                        {'\n\n'}
                        <Text style={RuleStyles.SubHeading3}>Who to Seed in singles Qualifying</Text>
                        {'\n\n'}
                        <Text style={RuleStyles.SubHeading3}>Case: </Text>Seven (7) players listed in the Pepperstone ATP Rankings
                        ...
                        <Text style={RuleStyles.SubHeading3}>Decision: </Text>Eight (8) players. The seven (7) singles players and the
                        highest-positioned doubles player.
                        {'\n\n'}
                        <Text style={RuleStyles.SubHeading3}>Player Pulled from ATP Tour 250 and 500 Qualifying</Text>
                        {'\n\n'}
                        <Text style={RuleStyles.SubHeading3}>Case: </Text>An ATP Tour 500 and an ATP Tour 250 or a different ATP
