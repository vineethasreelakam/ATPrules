      ...
      <View style={RuleStyles.Layout}>
        <ScrollView style={RuleStyles.ScrollViewStyle} minimumZoomScale={1} maximumZoomScale={10}>
          ...
          <Text style={RuleStyles.Description}>
            <Text style={RuleStyles.SubHeading1}>6.01 Courts</Text>
            {'\n\n'}
            <Text style={RuleStyles.SubHeading2}>A.Court Surface</Text>
            ...
            {'\n\n'}
            <Text style={RuleStyles.SubHeading2}>B.Size, Position and Color of Courts</Text>
            {'\n\n'}
            ...
            {'\n\n'}
            <Text style={RuleStyles.SubHeading2}>C.Preparation of Surface</Text>
            {'\n\n'}
            ...
            {'\n\n'}
            <Text style={RuleStyles.SubHeading2}>D.Lighting</Text>
            {'\n\n'}
            <Text style={RuleStyles.SubHeading2}>1) Minimum Number of Lighted Courts</Text> – Outdoor events
            {'\n\n'}
            ...
            {'\n\n'}
            <Text style={RuleStyles.SubHeading2}>2) Intensity</Text>
            {'\n\n'}
            <Text style={RuleStyles.SubHeading3}>a) ATP Tour Tournaments.</Text> Lighting must be evenly distributed on the court
            ...
            temperature.
            {'\n\n'}
            <Text style={RuleStyles.SubHeading3}>b) ATP Challenger Tour Tournaments. </Text>Lighting must be evenly distributed on
            the court with a minimum recommended intensity of 70 foot-candles (750
            LUX), averaged over 15 readings on court
            {'\n\n'}
            <Text style={RuleStyles.SubHeading2}>3) High/low ratio.</Text> A ratio of the highest to lowest readings should be no greater than
            1x2.0 but the recommended ratio is 1x1.5.
            {'\n\n'}
            <Text style={RuleStyles.SubHeading2}>4) Light poles.</Text> Light poles should be positioned so that they are evenly distributed
            ...
            {'\n\n'}
            <Text style={RuleStyles.SubHeading2}>E. Back Fences, Back Walls, Banners, Signs and Seats</Text>
            {'\n\n'}
            ...
            <Text style={RuleStyles.SubHeading2}>F. Ceiling Height.</Text>
            {'\n\n'}
            <Text style={RuleStyles.SubHeading3}>1) ATP Events.</Text> Indoor or covered show courts shall have a minimum top height of
            ...
            {'\n\n'}
            <Text style={RuleStyles.SubHeading2}>G.On-Court Timing Devices</Text>
            {'\n\n'}
            ...
            {'\n\n'}
            <Text style={RuleStyles.SubHeading3}>1) Size.</Text> Each shot clock panel’s minimum recommended size is 2 x 2 feet (0.6 x 0.6
            meters). The recommended maximum size is 3 x 2 feet (0.91 x 0.6 meters).
            {'\n\n'}
            <Text style={RuleStyles.SubHeading3}>2) Number and Placement.</Text> Each court shall have, as a minimum, two (2) timing
            ...
            {'\n\n'}
            <Text style={RuleStyles.SubHeading3}>3) Additional Positions.</Text> Beyond the two (2) clock placements specified in 2)
            ...
            {'\n\n'}
            <Text style={RuleStyles.SubHeading2}>H. Electronic Review.</Text>
            {'\n\n'}
            ...
            {'\n\n'}
            <Text style={RuleStyles.SubHeading3}>Note: </Text>ATP approved electronic review systems is permitted for use at clay court
