                ...
                <ScrollView style={RuleStyles.ScrollViewStyle} minimumZoomScale={1} maximumZoomScale={10}>
                    ...
                    <ZoomText>
                        <HighlightText style={RuleStyles.Description}>
                            <HighlightText style={RuleStyles.SubHeading1}>7.21 Match Scheduling</HighlightText>
                            {'\n\n\t'}
                            <HighlightText style={RuleStyles.SubHeading2}>A.Scheduling Committee </HighlightText>
                            {'\n\n\t\t'}
                            ...
                            decision.
                            {'\n\n\t'}
                            <HighlightText style={RuleStyles.SubHeading3}>B.Tournament Week Plan </HighlightText>
                            {'\n\n\t\t'}
                            <HighlightText style={RuleStyles.SubHeading3}>1) Main Draw.</HighlightText>a The main draw should be scheduled so that the first round in singles
                            ...
                            {'\n\n\t\t\t'}
                            <HighlightText style={RuleStyles.SubHeading3}>a) Considerations and Priorities. The following priorities in the order listed
                                should be followed:</HighlightText>
                            {'\n\n\t\t\t\t'}
                            ...
                            {'\n\n\t\t'}
                            <HighlightText style={RuleStyles.SubHeading3}>2) ATP Tour Qualifying.</HighlightText> One (1) round per day except when weather or other unavoidable circumstances require two (2) rounds to be played on the same day.
                            {'\n\n\t\t\t'}
                            ...
                            event.
                            {'\n\n\t\t'}
                            <HighlightText style={RuleStyles.SubHeading3}>3) ATP Challenger Tour Qualifying.</HighlightText> One (1) round per day except when weather
                            or other unavoidable circumstances require two (2) rounds to be played on the
                            same day.
                            {'\n\n\t'}
                            <HighlightText style={RuleStyles.SubHeading2}>C.Daily Scheduling Overview </HighlightText>
                            {'\n\n\t\t'}
                            ...
                            {'\n\n\t\t\t\t'}
                            <HighlightText style={RuleStyles.SubHeading3}>ATP Tour 250 (16 draw doubles)</HighlightText>
                            {'\n\n\t\t\t\t'}
                            o Seven (7) doubles matches must be scheduled on the Center Court
                            during the tournament week.
                            {'\n\n\t\t\t\t'}
                            <HighlightText style={RuleStyles.SubHeading3}>ATP Tour 250 (24 draw doubles)</HighlightText>
                            {'\n\n\t\t\t\t'}
                            o Seven (7) doubles matches must be scheduled on the Center Court
                            during the tournament week.
                            {'\n\n\t\t\t\t'}
                            ...
                            second court.
                            {'\n\n\t\t\t\t'}
                            <HighlightText style={RuleStyles.SubHeading3}>ATP Tour 500 (16 draw doubles)</HighlightText>
                            {'\n\n\t\t\t\t'}
                            o Seven (7) doubles matches must be scheduled on the Center Court
                            during the tournament week.
                            {'\n\n\t\t\t\t'}
                            <HighlightText style={RuleStyles.SubHeading3}>ATP Tour 500 (24 draw doubles)</HighlightText>
                            {'\n\n\t\t\t\t'}
                            o Seven (7) doubles matches must be scheduled on the Center Court
                            during the tournament week.
                            {'\n\n\t\t\t\t'}
                            ...
                            second court.
                            {'\n\n\t\t\t\t'}
                            <HighlightText style={RuleStyles.SubHeading3}>ATP Tour Masters 1000 (24 draw doubles)</HighlightText>
                            {'\n\n\t\t\t\t'}
                            o Seven (7) doubles matches must be scheduled on the Center Court
                            during the tournament week.
                            {'\n\n\t\t\t\t'}
                            ...
                            {'\n\n\t\t\t\t'}
                            <HighlightText style={RuleStyles.SubHeading3}>ATP Tour Masters 1000 (32 draw doubles)</HighlightText>
                            {'\n\n\t\t\t\t'}
                            o Seven (7) doubles matches must be scheduled on the Center Court
                            during the tournament week.
                            {'\n\n\t\t\t\t'}
                            ...
                            second overall best court.
                            {'\n\n\t\t\t'}
                            <HighlightText style={RuleStyles.SubHeading3}>Final. </HighlightText>The doubles final is to be scheduled prior to the singles final. It is recommended that the time of the final is no earlier than two (2) hours before the
                            ...
                            {'\n\n\t\t\t'}
                            <HighlightText style={RuleStyles.SubHeading3}>a) Exceptional Circumstances may include, but are not limited to, the following:</HighlightText>
                            {'\n\n\t\t\t\t'}
                            ...
                            {'\n\n\t\t\t\t'}
                            <HighlightText style={RuleStyles.SubHeading3}>Violation of this section may subject the Tournament to the penalties set
                                forth in VIII. The Code - section 8.02 Tournament Violations.</HighlightText>
                            {'\n\n\t\t'}
                            ...
                            {'\n\n\t\t'}
                            <HighlightText style={RuleStyles.SubHeading3}>1) Release Deadline. </HighlightText>Once the scheduling committee determines the order of play,
                            it should be released no later than 10 p.m. local time at the tournament.
                            {'\n\n\t\t'}
                            <HighlightText style={RuleStyles.SubHeading3}>2) Change. Once released,</HighlightText> the order of play may not be changed except upon the
                            approval of the Supervisor.
                            {'\n\n\t\t'}
                            <HighlightText style={RuleStyles.SubHeading3}>3) Notification. </HighlightText>
                            {'\n\n\t\t\t'}
                            ...
                            {'\n\n\t\t'}
                            <HighlightText style={RuleStyles.SubHeading3}>4) Notes / Reminders. Daily order of play must have footnotes reflecting the following:</HighlightText>
                            {'\n\n\t\t\t'}
                            ...
                            {'\n\n\t'}
                            <HighlightText style={RuleStyles.SubHeading2}>E. Calling of Matches </HighlightText>
                            {'\n\n\t\t'}
                            ...
                            {'\n\n\t'}
                            <HighlightText style={RuleStyles.SubHeading2}>F. Rain </HighlightText>
                            {'\n\n\t\t'}
                            ...
                            {'\n\n\t\t\t'}
                            <HighlightText style={RuleStyles.SubHeading3}>Case:</HighlightText> A tournament with an approved and announced Saturday
                            ...
                            the tournament?
                            {'\n\n\t\t\t'}
                            <HighlightText style={RuleStyles.SubHeading3}>Decision: </HighlightText>No. For a tournament with a Saturday final the tournament week would end on Saturday and the one (1) extra day
                            ...
                            {'\n\n\t'}
                            <HighlightText style={RuleStyles.SubHeading2}>G.Rest Periods - Minimums and Guidelines</HighlightText>
                            {'\n\n\t\t'}
                            <HighlightText style={RuleStyles.SubHeading3}>1) Between Main Draw and Prior Week’s Tournament(s).</HighlightText> Before scheduling
                            ...
                            {'\n\n\t\t\t\t'}
                            <HighlightText style={RuleStyles.SubHeading3}>Case: </HighlightText>A player competes in a Grand Slam Junior match on the final
                            Sunday. Is he eligible for a Wednesday start if his next tournament
                            is the following week and on a different continent?
                            {'\n\n\t\t\t\t'}
                            <HighlightText style={RuleStyles.SubHeading3}>Decision: </HighlightText>No. The Wednesday start provisions indicated in the ATP
                            ...
                            {'\n\n\t\t\t\t'}
                            <HighlightText style={RuleStyles.SubHeading3}>Case:</HighlightText> Due to weather or other unforeseen circumstances, a player
                            ...
                            Tuesday?
                            {'\n\n\t\t\t\t'}
                            <HighlightText style={RuleStyles.SubHeading3}>Decision: </HighlightText>Yes. The provision of not playing on Monday after playing
                            two qualifying matches on Sunday does not apply as there are no
                            Wednesday starts permitted.
                            {'\n\n\t\t'}
                            <HighlightText style={RuleStyles.SubHeading3}>3) Between Main Draw Matches.</HighlightText>
                            {'\n\n\t\t\t'}
                            ...
                            {'\n\n\t\t\t\t'}
                            <HighlightText style={RuleStyles.SubHeading3}>Player Entitled to Minimum Rest</HighlightText>
                            {'\n\n\t\t\t\t'}
                            <HighlightText style={RuleStyles.SubHeading3}>Case: </HighlightText>Because of rain delays, the singles semi-final and final
                            ...
                            {'\n\n\t\t\t\t'}
                            <HighlightText style={RuleStyles.SubHeading3}>Decision:</HighlightText> The player is entitled to a minimum rest of 1 1/2 hours.
                            The final cannot start before 2:45 p.m.
                            {'\n\n\t\t\t\t'}
                            <HighlightText style={RuleStyles.SubHeading3}>Note:</HighlightText> In circumstances where television is a factor, the Supervisor
                            ...
                            final.
                            {'\n\n\t\t\t\t'}
                            <HighlightText style={RuleStyles.SubHeading3}>Rain: </HighlightText>How Many Matches Per Player?
                            {'\n\n\t\t\t\t'}
                            <HighlightText style={RuleStyles.SubHeading3}>Case: </HighlightText>Rain has put the tournament behind schedule. Player A’s
                            ...
                            play the next day?
                            {'\n\n\t\t\t\t'}
                            <HighlightText style={RuleStyles.SubHeading3}>Decision: </HighlightText>Three (3). Completion of a match shall count as one (1)
                            ...
                            doubles matches.
                            {'\n\n\t\t\t\t'}
                            <HighlightText style={RuleStyles.SubHeading3}>Scheduling Priorities</HighlightText>
                            {'\n\n\t\t\t\t'}
                            <HighlightText style={RuleStyles.SubHeading3}>Case:</HighlightText> In preparing the schedule of play for Wednesday in a 32-
                            ...
                            {'\n\n\t\t\t\t'}
                            <HighlightText style={RuleStyles.SubHeading3}>Decision:</HighlightText> Scheduling in outdoor events must keep sections of
                            ...
                            {'\n\n\t\t\t\t'}
                            <HighlightText style={RuleStyles.SubHeading3}>Decision:</HighlightText> No. Every effort must be made to finish the tournament
                            ...
                            Policy)
                            {'\n\n\t\t\t\t'}
                            <HighlightText style={RuleStyles.SubHeading3}>Moving Indoors at an Outdoor event</HighlightText>
                            {'\n\n\t\t\t\t'}
                            <HighlightText style={RuleStyles.SubHeading3}>Case: </HighlightText>Rain has disrupted play to the point where the event is in
                            ...
                            event?
                            {'\n\n\t\t\t\t'}
                            <HighlightText style={RuleStyles.SubHeading3}>Decision: </HighlightText>Yes. Under the responsibilities of the Supervisor it states
