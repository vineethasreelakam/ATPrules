                ...
                <ScrollView style={RuleStyles.ScrollViewStyle} minimumZoomScale={1} maximumZoomScale={10}>
                    ...
                    <ZoomText>
                        <HighlightText style={RuleStyles.Description}>
                            ...
                            {'\n\n'}
                            <HighlightText style={RuleStyles.SubHeading3}>) Considerations and Priorities. The following priorities in the order listed
                                should be followed:</HighlightText>a
                            {'\n\n'}
                            ...
                            {'\n\n'}
                            <HighlightText style={RuleStyles.SubHeadin2}>F. Rain </HighlightText>
                            {'\n\n'}
