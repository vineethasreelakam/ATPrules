            ...
            <View style={RuleStyles.Layout}>
                <ScrollView style={RuleStyles.ScrollViewStyle} minimumZoomScale={1} maximumZoomScale={10}>
                    ...
                    <Text style={RuleStyles.Description}>
                        <Text style={RuleStyles.SubHeading1}>7.10 Special Exempts (SE)</Text>
                        {'\n\n'}
                        <Text style={RuleStyles.SubHeading2}> A.Eligibility</Text>
                        {'\n\n'}
                        ...
                        *The 250 event must be located in the same region as the 500 event, as
                        ...
                        {'\n\n'}
                        <Text style={RuleStyles.SubHeading3}>EXCEPTION 1:</Text> A player who has entered and been accepted into the qualifying draw of an ATP Tour tournament and has been withdrawn because he is
                        ...
                        {'\n\n'}
                        <Text style={RuleStyles.SubHeading3}>EXCEPTION 2: </Text>A player who has entered and been accepted into the qualifying draw of an ATP Tour 500 tournament and has been withdrawn because he
                        ...
                        {'\n\n'}
                        <Text style={RuleStyles.SubHeading2}>B. Number of Special Exempts</Text>
                        {'\n\n'}
                        ...
                        {'\n\n'}
                        <Text style={RuleStyles.SubHeading2}></Text>C.Selection of Special Exempt
                        {'\n\n'}
                        ...
                        {'\n\n'}
                        <Text style={RuleStyles.SubHeading2}></Text>2) ATP Tour. If the special exempt places are not needed before the beginning of
                        ...
                        {'\n\n'}
                        <Text style={RuleStyles.SubHeading2}></Text>3) ATP Challenger Tour. If the special exempt place is not needed prior to the 10
                        ...
                        {'\n\n'}
                        <Text style={RuleStyles.SubHeading2}></Text>D.Special Exempt Process
                        {'\n\n'}
                        ...
                        {'\n\n'}
                        <Text style={RuleStyles.SubHeading3}></Text>NOTE: The deadline for a player to declare his intent to accept a Special Exempt,
                        ...
                        {'\n\n'}
                        <Text style={RuleStyles.SubHeading3}>Potential Special Exempt Playing at 9 p.m. Friday</Text>
                        {'\n\n'}
                        <Text style={RuleStyles.SubHeading3}>Case:</Text> A player is competing in the singles event of a “qualified
                        ...
                        {'\n\n'}
                        <Text style={RuleStyles.SubHeading3}>Decision: </Text>The special exempt slot in the main draw shall be left
                        ...
                        *For ATP Challenger Tour events, the vacancy is filled from the next
                        ...
                        at that event.
                        {'\n\n'}
                        <Text style={RuleStyles.SubHeading2}>Potential Special Exempt Loses: After 9 p.m.</Text>
                        {'\n\n'}
                        <Text style={RuleStyles.SubHeading3}>Case: </Text>A potential special exempt player loses his match at 9:15
                        ...
                        has not been made?
                        {'\n\n'}
                        <Text style={RuleStyles.SubHeading3}>Decision:</Text> Yes. The wild card belongs to the tournament, which may
                        ...
                        player.
                        {'\n\n'}
                        <Text style={RuleStyles.SubHeading3}>Potential Special Exempt Playing at Midnight On the Night Prior
                            to the Start of Qualifying</Text>
                        {'\n\n'}
                        <Text style={RuleStyles.SubHeading3}>Case: </Text>Same situation as above, except that the player’s match is
                        ...
                        event?
                        {'\n\n'}
                        <Text style={RuleStyles.SubHeading3}>Decision:</Text> No. For the purpose of the rule, competing on the date
                        ...
                        {'\n\n'}
                        <Text style={RuleStyles.SubHeading3}>Case:</Text> A tournament has a Saturday final and a player asks for a
                        special exempt after he wins his quarterfinal match on Thursday. Is
                        he eligible?
                        {'\n\n'}
                        <Text style={RuleStyles.SubHeading3}>Decision:</Text> No. The player must be scheduled to play on Saturday
                        when the “qualifying begins”.
                        {'\n\n'}
                        <Text style={RuleStyles.SubHeading3}>Case: </Text>A player is a potential special exempt for one or more
                        Challenger tournaments. Can he also preserve his eligibility on an
                        original acceptance list?
                        {'\n\n'}
                        <Text style={RuleStyles.SubHeading3}>Decision:</Text> Yes. A player who is a possible special exempt may also
                        preserve his eligibility on an original acceptance list, however the
                        player may only preserve his eligibility on one list.
                        {'\n\n'}
                        <Text style={RuleStyles.SubHeading3}>NOTE:</Text> If he preserves his eligibility on an original acceptance list
                        ...
                        the main draw first.
                        {'\n\n'}
                        <Text style={RuleStyles.SubHeading3}>Case: </Text>A player has won a position as a Special Exempt but he is
                        ...
                        {'\n\n'}
                        <Text style={RuleStyles.SubHeading3}>Decision: </Text>Yes, since the player ultimately got in because he was
                        ...
                        {'\n\n'}
                        <Text style={RuleStyles.SubHeading3}></Text>Am I kept on the Special Exempt List?
                        {'\n\n'}
                        <Text style={RuleStyles.SubHeading3}>Case: </Text>A player expresses an interest in a Special Exempt spot prior
                        ...
                        {'\n\n'}
                        <Text style={RuleStyles.SubHeading3}>Decision:</Text> No. If the player does not contact the Supervisor or
                        ...
                        {'\n\n'}
                        <Text style={RuleStyles.SubHeading3}>Must I Appear for Play After Accepting a Special Exempt?</Text>
                        {'\n\n'}
                        <Text style={RuleStyles.SubHeading3}>Case:</Text> A player is listed as a possible Special Exempt and the
                        ...
                        Special Exempt?
                        {'\n\n'}
                        <Text style={RuleStyles.SubHeading3}>Decision: </Text>Yes. Because he had accepted the Special Exempt spot
                        ...
                        {'\n\n'}
                        <Text style={RuleStyles.SubHeading3}>Case:</Text> Can a player with no ranking receive a Special Exempt if
                        otherwise eligible?
                        {'\n\n'}
                        <Text style={RuleStyles.SubHeading3}>Decision:</Text> No. A player must have a singles ranking or a singles
                        protected ranking in order to be considered for a Special Exempt.
                        {'\n\n'}
                        <Text style={RuleStyles.SubHeading3}>Case:</Text> May a player who has entered and been accepted into an
                        ...
                        {'\n\n'}
                        <Text style={RuleStyles.SubHeading3}>Decision:</Text> Yes, however the player must decide on Friday within an
