            ...
            <View style={RuleStyles.Layout}>
                <ScrollView style={RuleStyles.ScrollViewStyle} minimumZoomScale={1} maximumZoomScale={10}>
                    ...
                    <HighlightText style={RuleStyles.Description}>
                        <HighlightText style={RuleStyles.SubHeading1}>7.18 Byes - Assignment and Placement </HighlightText>
                        {'\n\n'}
                        ...
                        {'\n\n'}
                        <HighlightText style={RuleStyles.SubHeading2}>B.Doubles Main Draw</HighlightText>
                        {'\n\n'}
                        ...
                        {'\n\n'}
                        <HighlightText style={RuleStyles.SubHeading2}>C.Qualifying Draw</HighlightText>
                        {'\n\n'}
