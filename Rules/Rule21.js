      ...
      <View style={RuleStyles.Layout}>
        <ScrollView style={RuleStyles.ScrollViewStyle} minimumZoomScale={1} maximumZoomScale={10}>
          ...
          <HighlightText style={RuleStyles.Description}>
            ...
            {'\t\t\t'}<HighlightText style={{ fontStyle: 'italic' }}> <HighlightText style={{fontWeight: 'bold' }}>Case:</HighlightText> A player plays and wins his first match. He then becomes ill
            and withdraws from the tournament. When does his hospitality end?{'\n\n'}
            {'\t\t\t'}<HighlightText style={{fontWeight: 'bold' }}>Decision: </HighlightText>The player who retired from a match or withdrew after
            ...
            examination, whichever is later.</HighlightText>{'\n\n'}
 ...
 */}
           ...
           {'\t\t\t\t'}<HighlightText style={RuleStyles.SubHeading3}>i) Singles: </HighlightText>
            ...
            {'\t\t\t'}<HighlightText style={{ fontStyle: 'italic' }}> <HighlightText style={{fontWeight: 'bold' }}>Case:</HighlightText> A player accepted into the Singles Main Draw of a Challenger
            ...
            {'\t\t\t'}<HighlightText style={{fontWeight: 'bold' }}>Decision:</HighlightText> No, the player forfeits hotel accommodation privileges for
            the tournament week (singles and doubles).</HighlightText>{'\n\n'}
