            ...
            <View style={RuleStyles.Layout}>
                <ScrollView style={RuleStyles.ScrollViewStyle} minimumZoomScale={1} maximumZoomScale={10}>
                    ...
                    <Text style={RuleStyles.Description}>
                        <Text style={RuleStyles.SubHeading1}>7.23 Line Umpire Requirement, Positions and Calls</Text>
                        {'\n\n'}
                        <Text style={RuleStyles.SubHeading2}>A.Number for Matches</Text>
                        {'\n\n'}
                        <Text style={RuleStyles.SubHeading3}>1) Full Complement of Line Umpires.</Text> If a Chair Umpire has a full complement of
                        ...
                        {'\n\n'}
                        <Text style={RuleStyles.SubHeading3}>2) Less than a Full Complement of Line Umpires.</Text> If less than a full complement
                        ...
                        {'\n\n'}
                        <Text style={RuleStyles.SubHeading3}>a) Seven (7) Line Umpires.</Text> All long lines are called only up to the net. Serves
                        ...
                        {'\n\n'}
                        <Text style={RuleStyles.SubHeading3}>b) Six (6) Line Umpires.</Text>
                        {'\n\n'}
                        ...
                        iv) Chair umpire calls all “Lets,” “Not Ups,” “Foul Shots,” “Touches,” “Hindrances” and “Throughs.”
                        {'\n\n'}
                        <Text style={RuleStyles.SubHeading3}>c) Five (5) Line Umpires.</Text> The assignments are the same as for the six (6) man
                        crew, except that the center service Line Umpire shall move after the serve to
                        the side line.
                        {'\n\n'}
                        <Text style={RuleStyles.SubHeading3}>d) Four (4) Line Umpires.</Text> The assignments are the same as for the five (5)
                        ...
                        {'\n\n'}
                        <Text style={RuleStyles.SubHeading3}>e) Less Than Four (4) Line Umpires.</Text> The Chair Umpire shall assign the Line
                        Umpires to the best advantage possible.
                        {'\n\n'}
                        <Text style={RuleStyles.SubHeading3}>f) Umpiring Without Line Umpires.</Text> If a Chair Umpire is required to umpire a
                        ...
                        {'\n\n'}
                        <Text style={RuleStyles.SubHeading3}>Players Don’t Call Lines</Text>
                        {'\n\n'}
                        <Text style={RuleStyles.SubHeading3}>Case:</Text> In ATP Tour or ATP Challenger Tour qualifying events where
                        ...
                        {'\n\n'}
                        <Text style={RuleStyles.SubHeading3}>Decision:</Text> No. If a Chair Umpire is required to umpire a match
                        ...
                        unattended lines.
                        {'\n\n'}
                        <Text style={RuleStyles.SubHeading2}> B.Hand Signals of Line Umpires </Text>
                        {'\n\n'}
                        The approved hand signals are as follows:
                        {'\n\n'}
                        <Text style={RuleStyles.SubHeading3}>1) “Out” or “Fault.” </Text>The arm should be fully extended sideways at shoulder height,
                        ...
                        {'\n\n'}
                        <Text style={RuleStyles.SubHeading3}>2) “Good Ball.”</Text> The hands shall be pointed down with palms down and fingers
                        ...
                        {'\n\n'}
                        <Text style={RuleStyles.SubHeading3}>3) “Unsighted.”</Text> The hands are placed beneath the eyes facing in the direction of
