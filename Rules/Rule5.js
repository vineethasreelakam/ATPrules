      ...
      <View style={RuleStyles.Layout}>
        <ScrollView style={RuleStyles.ScrollViewStyle} minimumZoomScale={1} maximumZoomScale={10}>
          ...
          <Text style={RuleStyles.Description}>
            <Text style={RuleStyles.SubHeading1}>1.04 Finals Options</Text>{'\n\n'}
            ...
            <Text style={RuleStyles.SubHeading2}>B. Singles</Text>{'\n\n'}
            ...
            <Text style={RuleStyles.SubHeading2}>C. Doubles.</Text>{'\n\n'}
