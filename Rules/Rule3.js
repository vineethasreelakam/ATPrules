      ...
      <View style={RuleStyles.Layout}>
        <ScrollView style={RuleStyles.ScrollViewStyle} minimumZoomScale={1} maximumZoomScale={10}>
          ...
          <Text style={RuleStyles.Description}>
            <Text style={RuleStyles.SubHeading1}>1.02 Tournament Week{'\n\n'} </Text>
            <Text style={RuleStyles.SubHeading2}>A.Main Draw {'\n\n'}</Text>
            ...
            <Text style={RuleStyles.SubHeading2}>B.Matches – Number of Sets.{'\n\n'} </Text>
            ...
            <Text style={RuleStyles.SubHeading2}>C.Monday Finals. </Text>{'\n\n'}
            ...
            <Text style={RuleStyles.SubHeading2}>D.Qualifying. {'\n\n'}</Text>
            ...
            <Text style={RuleStyles.SubHeading3}>a) ATP Challenger 50-125. </Text>
            ...
            <Text style={RuleStyles.SubHeading3}>3) General. </Text>
            ...
            <Text style={RuleStyles.SubHeading3}>4) Location. </Text>
            ...
            <Text style={RuleStyles.SubHeading3}>5) Surface. </Text>
