        ...
        <ScrollView style={RuleStyles.ScrollViewStyle} minimumZoomScale={1} maximumZoomScale={10}>
          ...
          <ZoomText>
            <Text style={RuleStyles.Description}>
              ...
              {'\n\n'}
              <Text style={RuleStyles.SubHeading2}>4) ATP Mental Health and Wellbeing</Text>
              {'\n\n'}
              ...
              {'\n\n'}
              <Text style={RuleStyles.SubHeading2}> 3) Massage Therapist.</Text>A minimum of one (1) Massage Therapist must be provided
