      ...
      <View style={RuleStyles.Layout}>
        <ScrollView style={RuleStyles.ScrollViewStyle} minimumZoomScale={1} maximumZoomScale={10}>
          ...
          <HighlightText style={RuleStyles.Description}>
            <HighlightText style={RuleStyles.SubHeading1}>3.08 Prize Money</HighlightText>{'\n\n'}
            <HighlightText style={RuleStyles.SubHeading2}>A.</HighlightText>
            All prize money due to ATP is to be sent by wire in USD or EUR.{'\n\n'}

            <HighlightText style={RuleStyles.SubHeading3}>1) </HighlightText>U.S. Dollar payment by wire{'\n\n'}
            {'\t'}Bank: BNP PARIBAS{'\n\n'}
            ...
            <HighlightText style={RuleStyles.SubHeading3}>2) </HighlightText>Euro payment by wire{'\n\n'}
            {'\t'}Bank: BNP PARIBAS{'\n\n'}
            {'\t'}1 boulevard des Moulins{'\n\n'}
            {'\t'}98000 Monaco{'\n\n'}
            {'\t'}Swift/BIC Code: BNPAMCM1XXX{'\n\n'}
            ...
            <HighlightText style={RuleStyles.SubHeading2}>Singles:</HighlightText>{'\n\n'}
            <HighlightText style={RuleStyles.SubHeading3}>a) </HighlightText>
            ...
            <HighlightText style={RuleStyles.SubHeading3}>Decision: No. </HighlightText>
            ...
            <HighlightText style={RuleStyles.SubHeading2}>Doubles - Prior to First Match:</HighlightText>{'\n\n'}
