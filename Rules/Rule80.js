            ...
            <View style={RuleStyles.Layout}>
                <ScrollView style={RuleStyles.ScrollViewStyle} minimumZoomScale={1} maximumZoomScale={10}>
                    ...
                    <Text style={RuleStyles.Description}>
                        <Text style={RuleStyles.SubHeading1}>6.16 Stringing Service</Text>
                        {'\n\n'}
                        <Text style={RuleStyles.SubHeading2}>A. General.</Text> A stringing service of a high professional standard must be made available
                        to the players throughout the length of the event. The machine used for stringing
                        must be an electronic model.
                        {'\n\n'}
                        <Text style={RuleStyles.SubHeading2}>B. Days / Hours of Service.</Text>
                        {'\n\n'}
                        ...
                        {'\n\n'}
                        <Text style={RuleStyles.SubHeading2}>C. Fees.</Text>
                        {'\n\n'}
                        <Text style={RuleStyles.SubHeading3}>1) ATP Tour Events. </Text>The recommended maximum fee per racquet is $20 USD /
                        €20 and is the responsibility of the stringing service to collect from the player.
                        {'\n\n'}
                        <Text style={RuleStyles.SubHeading3}>2) ATP Challenger Tour Events.</Text> The recommended maximum fee per racquet is
