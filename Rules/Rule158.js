      ...
      <View style={RuleStyles.Layout}>
        <ScrollView style={RuleStyles.ScrollViewStyle} minimumZoomScale={1} maximumZoomScale={10}>
          ...
          <Text style={RuleStyles.Description}>
            <Text style={RuleStyles.SubHeading1}>EXHIBIT C - Broadcast Standards</Text>{'\n\n'}

            <Text style={RuleStyles.SubHeading2}>Broadcast Quality Standards</Text>{'\n\n'}
            <Text style={RuleStyles.SubHeading3}>1) Tape Delay/Repeats</Text>{'\n\n'}
            ...
            <Text style={RuleStyles.SubHeading3}>2) Broadcaster’s Responsibilities</Text>{'\n\n'}
            ...
            <Text style={RuleStyles.SubHeading3}>3) Technical Requirements</Text>{'\n\n'}
            ...
            <Text style={RuleStyles.SubHeading2}>Cameras</Text>{'\n\n'}
            ...
            <Text style={RuleStyles.SubHeading3}>Camera 1: </Text>{'\n\n'}
            Tripod camera high up in the stands (Center Court line).{'\n\n'}

            <Text style={RuleStyles.SubHeading3}>Camera 2: </Text>{'\n\n'}
            Tripod camera approximately three (3) rows lower than Camera 1
            (Center Court line). (Example 1){'\n\n'}

            <Text style={RuleStyles.SubHeading3}>Cameras 3 and 4: </Text>{'\n\n'}
            ...
            <Text style={RuleStyles.SubHeading3}>Camera 5: </Text>{'\n\n'}
            ...
            <Text style={RuleStyles.SubHeading3}>Lenses</Text>{'\n\n'}
            Lenses for Camera 1 should be 18:1. Lenses for Cameras 2, 3, and 4
            should be 50:1.{'\n\n'}

            <Text style={RuleStyles.SubHeading3}>Microphones</Text>{'\n\n'}
            ...
            <Text style={RuleStyles.SubHeading3}>Center Court Masters 1000 Tournaments: </Text>{'\n\n'}
            ATP Masters 1000 tournament shall provide
            a fully cabled site and infrastructure for aerial camera
            system on center court.{'\n\n'}

            <Text style={RuleStyles.SubHeading3}>Television Regulation Regarding Same Day
              Exclusivity</Text>{'\n\n'}
