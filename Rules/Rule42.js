      ...
      <View style={RuleStyles.Layout}>
        <ScrollView style={RuleStyles.ScrollViewStyle} minimumZoomScale={1} maximumZoomScale={10}>
          ...
          <HighlightText style={RuleStyles.Description}>
            ...
            in accordance with this rule summarizing the 500 Submissions. The 500 PM 
            Committee Auditor will also act as advisor to the 500 PM Committee on financial and
            ...
            or any information that could reasonably lead to the calculation of individual 
            tournament information and the matching of the information to a particular tournament. The
            ...
            Barter valuations should be in accordance with local GAAP, US GAAP or IFRS 
            applicable to each tournament. The 500 PM Committee will work with the 500 PM 
            ...
            De Minimus barter transactions are defined as individual transactions with 
            valuations under $20,000 for 500 tournaments. De Minimus transactions are not
            ...
            reasonably requested by the 500 PM Committee Auditor similar in detail to the 
            previous Tournament Financial Review process, but also including full disclosure and
            ...
            determinable by the deadline for completing the 500 Submission. Subsequent 
            adjustments of these estimates to actual will be included in the 500 Tournament Income
